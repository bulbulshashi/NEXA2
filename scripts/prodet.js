...
M.onclick = ()=>{
  L.style.color = '#0B3948';
  L.style.backgroundColor = " #D9DBF1"
    M.style.backgroundColor = '#0B3948';
  M.style.color = " #D9DBF1"
    XL.style.color = '#0B3948';
  XL.style.backgroundColor = " #D9DBF1"
    XXL.style.color = '#0B3948';
  XXL.style.backgroundColor = " #D9DBF1"
  finalSize = 'M';
...
L.onclick = ()=>{
  L.style.backgroundColor = '#0B3948';
  L.style.color = " #D9DBF1"
    M.style.color = '#0B3948';
  M.style.backgroundColor = " #D9DBF1"
    XL.style.color = '#0B3948';
  XL.style.backgroundColor = " #D9DBF1"
    XXL.style.color = '#0B3948';
  XXL.style.backgroundColor = " #D9DBF1"
...
XL.onclick = ()=>{
  ...
  L.style.backgroundColor = " #D9DBF1"
    M.style.color = '#0B3948';
  M.style.backgroundColor = " #D9DBF1"
    XL.style.backgroundColor = '#0B3948';
  XL.style.color = " #D9DBF1"
    XXL.style.color = '#0B3948';
  XXL.style.backgroundColor = " #D9DBF1"
  finalSize = 'XL';
  productInfo[3]= finalSize;
...
XXL.onclick = ()=>{
  ...
  M.style.backgroundColor = " #D9DBF1"
    XL.style.color = '#0B3948';
  XL.style.backgroundColor = " #D9DBF1"
    XXL.style.backgroundColor = '#0B3948';
  XXL.style.color = " #D9DBF1"
  finalSize = 'XXL';
  productInfo[3]= finalSize;
  console.log(productInfo);
}
